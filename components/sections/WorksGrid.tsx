      ...
      {WORKS.map((work, index) => (
        ...
        >
          <div className="relative aspect-square overflow-hidden border border-white/10 bg-black/40">
            ...
            {/* code overlay on bottom left */}
            <div className="absolute bottom-3 left-4 text-[10px] md:text-[11px] uppercase tracking-[0.18em] text-white/70">
              <div className="font-semibold">{work.code}</div>
            </div>
          </div>
